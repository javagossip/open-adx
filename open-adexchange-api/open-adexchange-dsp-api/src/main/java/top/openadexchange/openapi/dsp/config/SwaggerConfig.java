...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        ...
        Components components = new Components().addSecuritySchemes("OaxTokenAuth", securityScheme);

        return new OpenAPI().components(components)
                .addServersItem(new Server().url("/"))
                .info(new Info().title("Open Ad Exchange dsp API Document")
                        .description("Open Ad Exchange dsp API Document")
                ...
                .addSecurityItem(new SecurityRequirement().addList("OaxTokenAuth"));
    }
}
